  ...
  const handleSignup = async (values: SignupValues) => {
    ...
    if (error) {
      ...
      toast({
        ...
        description: 'Welcome to AgriPlanner. You can now start planning your harvests.'
      });
      navigate('/');
    }
  };
    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-2xl">AgriPlanner</CardTitle>
          <CardDescription>
            Market Price & Harvest Planner for Farmers
          </CardDescription>
        </CardHeader>
        <CardContent>
